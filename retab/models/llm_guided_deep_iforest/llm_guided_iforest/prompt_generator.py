...
class LGIFPromptGenerator:
    ...
    Save prompts    
    """
    def __init__(self, dataset_info: Dict[str, Any], iforest_path, prompt_path):
    ...
    def save_prompt(self, iforest_path, prompt_path):
        print(f"Load IForest from {iforest_path}")
        print(f"Save prompts to {prompt_path}")
        pass
